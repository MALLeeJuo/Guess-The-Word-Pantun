...
public class Aga5_1 : MonoBehaviour //please change here
{
    Aga5_2 Callscript2; //please change here
    ...
    private string[] wordBank = { "haji" }; //please change here
    ...
    {
        LoadGame();
        Debug.Log("Aga5_1 Script loaded"); //please change here
        ChooseWord();
        UpdateUI();
    ...
    public void MakeGuess(char letter)
    {
        ...
        if (IsWordComplete())
        {
            ...
            Callscript2 = GameObject.FindGameObjectWithTag("CallScript2").GetComponent<Aga5_2>(); //please change here
