...
public class Aga4_1 : MonoBehaviour //please change here
{
    Aga4_2 Callscript2; //please change here
    ...
    private string[] wordBank = { "gelugur" }; //please change here
    ...
    {
        LoadGame();
        Debug.Log("Aga4_1 Script loaded"); //please change here
        ChooseWord();
        UpdateUI();
    ...
    public void MakeGuess(char letter)
    {
        ...
        if (IsWordComplete())
        {
            ...
            Callscript2 = GameObject.FindGameObjectWithTag("CallScript2").GetComponent<Aga4_2>(); //please change here
