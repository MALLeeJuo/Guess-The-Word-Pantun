...
public class Aga2_1 : MonoBehaviour //please change here
{
    Aga2_2 Callscript2; //please change here
    ...
    private string[] wordBank = { "dunia" }; //please change here
    ...
    {
        LoadGame();
        Debug.Log("Aga2_1 Script loaded"); //please change here
        ChooseWord();
        UpdateUI();
    ...
    public void MakeGuess(char letter)
    {
        ...
        if (IsWordComplete())
        {
            ...
            Callscript2 = GameObject.FindGameObjectWithTag("CallScript2").GetComponent<Aga2_2>(); //please change here
