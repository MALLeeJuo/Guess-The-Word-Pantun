...
public class Aga3_1 : MonoBehaviour //please change here
{
    Aga3_2 Callscript2; //please change here
    ...
    private string[] wordBank = { "kota" }; //please change here
    ...
    {
        LoadGame();
        Debug.Log("Aga3_1 Script loaded"); //please change here
        ChooseWord();
        UpdateUI();
    ...
    public void MakeGuess(char letter)
    {
        ...
        if (IsWordComplete())
        {
            ...
            Callscript2 = GameObject.FindGameObjectWithTag("CallScript2").GetComponent<Aga3_2>(); //please change here
