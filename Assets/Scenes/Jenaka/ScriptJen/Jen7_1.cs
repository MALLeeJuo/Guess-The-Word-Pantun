...
public class Jen7_1 : MonoBehaviour //please change here
{
    Jen7_2 Callscript2; //please change here
    ...
    private string[] wordBank = { "sawah" }; //please change here
    ...
    {
        LoadGame();
        Debug.Log("Jen7_1 Script loaded"); //please change here
        ChooseWord();
        UpdateUI();
    ...
    public void MakeGuess(char letter)
    {
        ...
        if (IsWordComplete())
        {
            ...
            Callscript2 = GameObject.FindGameObjectWithTag("CallScript2").GetComponent<Jen7_2>(); //please change here
