...
public class Jen2 : MonoBehaviour //please change here
{
    public TMP_Text wordDisplay;
    public TMP_Text wordDisplayDuplicate;
    ...
    private string[] wordBank = { "labi" }; //please change here
    private bool[] letterUsedAsHint;
    private bool timerGoing;
    private string currentWord;
    private string hiddenWord;
    private int maxAttempts = 3; //please change if double script
    ...
    {
        LoadGame();
        Debug.Log("Jen2 Script loaded"); //please change here
        ChooseWord();
        UpdateUI();
    ...
    private void UpdateUI()
    {
        ...
        wordDisplayDuplicate.text = FormathiddenWord();
