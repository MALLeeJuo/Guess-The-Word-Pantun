...
public class Jen8_1 : MonoBehaviour //please change here
{
    Jen8_2 Callscript2; //please change here
    ...
    private string[] wordBank = { "musang" }; //please change here
    ...
    {
        LoadGame();
        Debug.Log("Jen8_1 Script loaded"); //please change here
        ChooseWord();
        UpdateUI();
    ...
    public void MakeGuess(char letter)
    {
        ...
        if (IsWordComplete())
        {
            ...
            Callscript2 = GameObject.FindGameObjectWithTag("CallScript2").GetComponent<Jen8_2>(); //please change here
