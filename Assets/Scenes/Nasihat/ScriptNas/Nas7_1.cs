...
public class Nas7_1 : MonoBehaviour //please change here
{
    Nas7_2 Callscript2; //please change here
    ...
    private string[] wordBank = { "sembahyang" }; //please change here
    ...
    {
        LoadGame();
        Debug.Log("Nas7_1 Script loaded"); //please change here
        ChooseWord();
        UpdateUI();
    ...
    public void MakeGuess(char letter)
    {
        ...
        if (IsWordComplete())
        {
            ...
            Callscript2 = GameObject.FindGameObjectWithTag("CallScript2").GetComponent<Nas7_2>(); //please change here
