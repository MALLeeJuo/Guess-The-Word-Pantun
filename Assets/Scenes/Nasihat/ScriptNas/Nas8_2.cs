...
public class Nas8_2 : MonoBehaviour //please change here
{
    ...
    private string[] wordBank = { "kampung" }; //please change here
    ...
    {
        LoadGame();
        Debug.Log("Nas8_2 Script loaded"); //please change here
        ChooseWord();
        UpdateUI();
