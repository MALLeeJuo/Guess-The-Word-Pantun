...
public class Nas1 : MonoBehaviour //please change here
{
    ...
    //public AudioSource buttonClickSound; //test soundbutton

    private string[] wordBank = { "daun" }; //please change here
    ...
    private void Start()
    {
        Debug.Log("Nas1 Script loaded"); //please change here 
        ChooseWord();
        UpdateUI();
