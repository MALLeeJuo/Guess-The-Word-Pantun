...
public class Nas8_1 : MonoBehaviour //please change here
{
    Nas8_2 Callscript2; //please change here
    ...
    private string[] wordBank = { "kantung" }; //please change here
    ...
    {
        LoadGame();
        Debug.Log("Nas8_1 Script loaded"); //please change here
        ChooseWord();
        UpdateUI();
    ...
    public void MakeGuess(char letter)
    {
        ...
        if (IsWordComplete())
        {
            ...
            Callscript2 = GameObject.FindGameObjectWithTag("CallScript2").GetComponent<Nas8_2>(); //please change here
